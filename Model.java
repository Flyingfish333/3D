...
public class Model {
  ...
  public void render_spotlight1(GL3 gl, Mat4 modelMatrix, Vec3 angle) {
    ...
    shader.setVec3(gl,"light.direction", Front);
  ...
  public void render_spotlight(GL3 gl, Vec3 angle) {
    render_spotlight1(gl, modelMatrix, angle);
  }
